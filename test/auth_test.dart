...
//     });
//     test('Cannot log ouf if not initialized', () {
//       expect(
//         provider.logOut(),
...
//       expect(provider.currentUser, true);
//     });

//     test(
//       'Should be able to initialized is less than 2 seconds',
//       () async {
//         await provider.initialize();
//         expect(provider.currentUser, true);
//       },
...
//     //   final badEmailUser = provider.currentUser(
//     //     email: 'foo@bar.com',
//     //     password: 'anypass',
//     //   );
